...
config.DihedralAngle = [1.73, 0]; % [°]
config.SweepAngle = [0, 5]; % [°]
config.TaperRatio = [0.672, 0.8 / 1.4];
config.AspectRatio = [7.32, 3.0909];
config.Span = [10.92, 3.4];
config.LEPosition_X = [0, 4.3];
config.LEPosition_Y = [0, 0];
config.LEPosition_Z = [0, 0];

config.RotationAngle_X = [0, 0];
config.RotationAngle_Y = [3.5, 0];
config.RotationAngle_Z = [0, 0];

% Opzioni di discretizzazione
config.SemiSpanwiseDiscr = [10, 10];
config.ChordwiseDiscr = [10, 10];
