...
config.RootChord = [1.53, 0.98, 1.2];
config.DihedralAngle = [2, -5, -5]; % [°]
config.SweepAngle = [1.19, 0, 29.8]; % [°]
config.TaperRatio = [0.7/1.53, 0.5/0.98, 0.6/1.2];
config.AspectRatio = [11.96, 4.92, 4.57];
config.Span = [13.84, 3.28, 4.18];
config.LEPosition_X = [0, -5.3, 4.2];
config.LEPosition_Y = [0, 0, 0];
config.LEPosition_Z = [0, -0.95, 1.8];

config.RotationAngle_X = [0, 0, 0];
config.RotationAngle_Y = [-2, 5, 3];
config.RotationAngle_Z = [0, 0, 0];

% Opzioni di discretizzazione
config.SemiSpanwiseDiscr = [10, 10, 10];
config.ChordwiseDiscr = [10, 10, 10];
